    ...
    <div className="all">
      <div className="bb">
        ...
        <ul className="nav-links">
          <li onClick={() => navigate("/")}>Home <IoIosHome /></li>
          <li onClick={() => navigate("/courses")}>Courses <FaBook /></li>
          <li onClick={() => navigate("/about")}>About us <CgFileDocument /></li>

          {isLoggedIn && (
            <>
              <li onClick={() => navigate("/profile")}>Profile <CgProfile /></li>
              <li onClick={() => navigate("/favourite")}>Favourite <MdOutlineFavorite /></li>
            </>
          )}
        ...
        <div className="auth-buttons">
          {isLoggedIn ? (
            ...
            <>
              ...
              <Button className="btn-btn1" onClick={() => navigate("/register")}>
